...
-- tab navigation
bind("n", "<leader>tj", "<cmd>tabnext<cr>", { desc = "Next tab" })
bind("n", "<leader>tk", "<cmd>tabprev<cr>", { desc = "Prev tab" })
bind("n", "<leader>tn", "<cmd>tabnew<cr>", { desc = "New tab" })
bind("n", "<leader>tc", "<cmd>tabclose<cr>", { desc = "Close tab" })
bind("n", "<leader>Q", ":q!<CR>")
bind("n", "<leader>X", ":qa!<CR>")
